from football_sync.telegram import format_failure, format_success
...
def test_success_summary_is_research_only_and_caps_at_two_predictions() -> None:
    report = {
        ...
        "predictions": [
            {"league": "MLS", "home_team": "A", "away_team": "B", "score": "1-0", "lean": "主隊傾向", "stars": 4},
            {"league": "La Liga", "home_team": "C", "away_team": "D", "score": "1-1", "lean": "和局傾向", "stars": 3},
